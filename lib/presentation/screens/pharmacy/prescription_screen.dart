...
class _PrescriptionScreenState extends State<PrescriptionScreen> {
  ...
  Widget _stateBuilder(BuildContext context, QrState state) {
    return Skeletonizer(
      enabled: state.stateType == QrStateType.isLoading,
      child: Padding(
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Text(state.orderEntity.prescription.id.toString(), style: GoogleFonts.montserrat(fontWeight: FontWeight.w500, fontSize: 16.0),)
              ],
            ),
